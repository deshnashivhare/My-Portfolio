...
function animateIntroText() {
    const text = "Hi, I'm Deshna Shivhare";
...
function initDownloadResume() {
    ...
    if (downloadBtn) {
        downloadBtn.addEventListener('click', function(e) {
            ...
            link.href = 'C:\Users\INDIAN\OneDrive\Desktop\web development udemy\My Portfolio final\Deshna Shivhare Resume.pdf';
            link.download = 'C:\Users\INDIAN\OneDrive\Desktop\web development udemy\My Portfolio final\Deshna Shivhare Resume.pdf';
            link.target = '_blank';
